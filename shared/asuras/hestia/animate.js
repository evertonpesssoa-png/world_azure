// shared/asuras/hestia/animate.js
// Versão CORRIGIDA para HESTIA - com balanças da justiça, luz celestial e anéis sagrados
...
export function startAnimation(scene, camera, renderer, controls, particles, ring, ring2, fillLight, circleGlow, divineLight, scaleGroup, scaleGroup2) {
    ...
    function animate() {
        ...
        // 5. BALANÇAS DA JUSTIÇA (balanço suave)
    ...
    return { 
        setMixer: (m) => { 
            mixer = m; 
            console.log("✅ Mixer da HESTIA conectado!");
        },
