...
export function initFloor(scene, config) {
    const gridHelper = new THREE.GridHelper(14, 24, config.color, 0x664400);
    ...
    const groundPlane = new THREE.Mesh(
        ...
        new THREE.MeshStandardMaterial({ color: 0x1a0f00, roughness: 0.5, metalness: 0.4, transparent: true, opacity: 0.5 })
    );
